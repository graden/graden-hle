...
exports.create = function(req, res) {
    ...
    var dirGroups  = req.body.dirGroups;
    var permit     = true; //req.body.name;
    var type       = 'object'; //req.body.type;
    Object.create(name, type, permit, dirGroups, function(err, object) {
        if (err) {
...
exports.update = function(req, res) {
    ...
    var permit     = true; //req.body.name;
    var type       = 'object'; //req.body.type;
    Object.update(id, name, type, permit, dirGroups, function(err, object) {
        if (err) {
            res.status(403).json(err);
        } else {
            res.status(200).json(object);
