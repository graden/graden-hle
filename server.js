...
var app = express();
    ...
    app.post('/period/create', require('routes/periods').create);
    app.post('/period/update', require('routes/periods').update);
    app.post('/period/remove', require('routes/periods').remove);
